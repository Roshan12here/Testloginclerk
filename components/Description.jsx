      ...
      {images.map((elem, idx) => (
        ...
        >
          <motion.div
            ...
            className="w-full"
          >
            <div className="py-16 text-5xl text-[#006837] font-extrabold">{elem.title}</div>
          ...
          <div className="absolute md:bottom-1 bottom-10 right-10 md:right-0 w-full flex justify-center items-center">
            <div
              className="absolute  bg-[#006837] bottom-2 right-10 cursor-pointer"
              onClick={clickPrev}
            >
              <Image src={left} alt="" />
            </div>
            ...
            <div
              className="absolute bottom-2 bg-[#006837] right-2 cursor-pointer"
              onClick={clickNext}
            >
              <Image src={right} alt="" />
            </div>
